...
public class Sql_data {
	...
	//sqldata database variables: cnr-name-bednumber-tablenumber-year-terrain-bike-trip-guitar-waffleiron-hunting-fishing-specialities-wood

	/**
	 * Retrieves the tableinformation for the Cabins in the sql database, and makes an array with sqldata objects.
	 *  . 
	...
	public static  ObservableList<Cabin> getCabinData() throws SQLException{
		connect();
		ResultSet cabin = getTableInformation("sqldata");
		Cabin c;
	...
	public static void updateCabindata(String itemName, String value, String id) throws SQLException{
		connect();
		updateSqlTable("sqldata", itemName, value, "cnr", id);
		closeConnection();
	}
	/**
